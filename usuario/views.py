...
def valida_cadastro(request):    
    if request.method == 'POST':
        ...
        try:
            ...
            status_messages = {'class': 'bg-success text-white', 'message': 'Usuário cadastrado com sucesso!!'}
            return render(request, 'cadastro.html', {'status_messages': status_messages})
        
        except ValueError as error:
            error_message = str(error)
            status_messages = {'class': 'bg-danger text-white', 'message': error_message}
            return render(request, 'cadastro.html', {'status_messages': status_messages})
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            if user is not None:
                ...
                status_message = {'class': 'bg-danger text-white', 'message': 'Email ou senha incorretos.'}
...
def sair(request):
    ...
    return redirect('attorney:index')
